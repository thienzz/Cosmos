...
export const ENT_COVERAGE_FIXTURE: readonly EntCoverageRow[] = Object.freeze([
  ...
  // Tier B small bodies (T-V-45..47) — Bus-DeMeo + active/MBC/damocloid.
  { id: 'ENT-4070', subtype: 'Bus-DeMeo A',  shader: 'smallbody-asteroid', status: 'shipped', note: 'T-V-45 BDM_A olivine-rich' },
  { id: 'ENT-4071', subtype: 'Bus-DeMeo B',  shader: 'smallbody-asteroid', status: 'shipped', note: 'T-V-45 BDM_B hydrated C' },
  { id: 'ENT-4072', subtype: 'Bus-DeMeo Cb', shader: 'smallbody-asteroid', status: 'shipped', note: 'T-V-45 BDM_CB' },
  { id: 'ENT-4073', subtype: 'Bus-DeMeo Cg', shader: 'smallbody-asteroid', status: 'shipped', note: 'T-V-45 BDM_CG' },
  { id: 'ENT-4074', subtype: 'Bus-DeMeo Cgh',shader: 'smallbody-asteroid', status: 'shipped', note: 'T-V-45 BDM_CGH' },
  { id: 'ENT-4075', subtype: 'Bus-DeMeo Ch', shader: 'smallbody-asteroid', status: 'shipped', note: 'T-V-45 BDM_CH hydrated phyllosilicate' },
  { id: 'ENT-4076', subtype: 'Bus-DeMeo D',  shader: 'smallbody-asteroid', status: 'shipped', note: 'T-V-45 BDM_D primitive red' },
  { id: 'ENT-4077', subtype: 'Bus-DeMeo K',  shader: 'smallbody-asteroid', status: 'shipped', note: 'T-V-45 BDM_K CV/CO chondrite' },
  { id: 'ENT-4078', subtype: 'Bus-DeMeo L',  shader: 'smallbody-asteroid', status: 'shipped', note: 'T-V-45 BDM_L' },
  { id: 'ENT-4079', subtype: 'Bus-DeMeo Ld', shader: 'smallbody-asteroid', status: 'shipped', note: 'T-V-45 BDM_LD extreme L' },
  { id: 'ENT-4080', subtype: 'Bus-DeMeo O',  shader: 'smallbody-asteroid', status: 'shipped', note: 'T-V-45 BDM_O oddballs' },
  { id: 'ENT-4081', subtype: 'Bus-DeMeo Q',  shader: 'smallbody-asteroid', status: 'shipped', note: 'T-V-45 BDM_Q fresh silicate' },
  { id: 'ENT-4082', subtype: 'Bus-DeMeo R',  shader: 'smallbody-asteroid', status: 'shipped', note: 'T-V-45 BDM_R pyroxene-rich' },
  { id: 'ENT-4083', subtype: 'Bus-DeMeo Sa', shader: 'smallbody-asteroid', status: 'shipped', note: 'T-V-45 BDM_SA' },
  { id: 'ENT-4084', subtype: 'Bus-DeMeo Sq', shader: 'smallbody-asteroid', status: 'shipped', note: 'T-V-45 BDM_SQ' },
  { id: 'ENT-4085', subtype: 'Bus-DeMeo Sr', shader: 'smallbody-asteroid', status: 'shipped', note: 'T-V-45 BDM_SR' },
  { id: 'ENT-4086', subtype: 'Bus-DeMeo T',  shader: 'smallbody-asteroid', status: 'shipped', note: 'T-V-45 BDM_T dark red' },
  { id: 'ENT-4087', subtype: 'Bus-DeMeo Xc', shader: 'smallbody-asteroid', status: 'shipped', note: 'T-V-45 BDM_XC' },
  { id: 'ENT-4088', subtype: 'Bus-DeMeo Xe', shader: 'smallbody-asteroid', status: 'shipped', note: 'T-V-45 BDM_XE' },
  { id: 'ENT-4089', subtype: 'Bus-DeMeo Xk', shader: 'smallbody-asteroid', status: 'shipped', note: 'T-V-45 BDM_XK' },
  { id: 'ENT-4094', subtype: 'Active Asteroid', shader: 'smallbody-asteroid', status: 'shipped', note: 'T-V-46 ACTIVE_ASTEROID dust emission' },
  { id: 'ENT-4095', subtype: 'Main-Belt Comet', shader: 'smallbody-comet',    status: 'shipped', note: 'T-V-46 MAIN_BELT_COMET' },
  { id: 'ENT-4096', subtype: 'Damocloid',       shader: 'smallbody-asteroid', status: 'shipped', note: 'T-V-46 DAMOCLOID extinct-comet hyperbolic' },
  { id: 'ENT-4097', subtype: 'Neptune Trojan',  shader: 'smallbody-trojan',   status: 'shipped', note: 'T-V-46 TROJAN_NEPTUNE D-type extended' },
