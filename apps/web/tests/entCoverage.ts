...
export const ENT_COVERAGE_FIXTURE: readonly EntCoverageRow[] = Object.freeze([
  ...
  { id: 'ENT-2026', subtype: 'Neptune',      shader: 'planet-gas',     status: 'planned' },
  { id: 'ENT-2030', subtype: 'Hot Jupiter',  shader: 'planet-gas',     status: 'planned' },
  { id: 'ENT-2031', subtype: 'Super-Earth',  shader: 'planet-rocky',   status: 'planned' },
  { id: 'ENT-2032', subtype: 'Mini-Neptune', shader: 'planet-gas',     status: 'planned' },
  { id: 'ENT-2033', subtype: 'Hycean',       shader: 'planet-extreme', status: 'planned' },
  { id: 'ENT-2034', subtype: 'Eyeball',      shader: 'planet-extreme', status: 'planned' },
  { id: 'ENT-2035', subtype: 'Magma',        shader: 'planet-rocky',   status: 'planned' },
  { id: 'ENT-2036', subtype: 'Ocean',        shader: 'planet-rocky',   status: 'planned' },
  { id: 'ENT-2037', subtype: 'Carbon',       shader: 'planet-rocky',   status: 'planned' },
  { id: 'ENT-2038', subtype: 'Iron',         shader: 'planet-rocky',   status: 'planned' },
  { id: 'ENT-2039', subtype: 'Desert',       shader: 'planet-rocky',   status: 'planned' },
  { id: 'ENT-2040', subtype: 'Rogue',        shader: 'planet-rocky',   status: 'planned' },
  { id: 'ENT-2041', subtype: 'Puffy',        shader: 'planet-gas',     status: 'planned' },
  { id: 'ENT-2042', subtype: 'Protoplanet',  shader: 'planet-rocky',   status: 'planned' },
  { id: 'ENT-2043', subtype: 'Tidally-Heated Io-Type', shader: 'planet-extreme', status: 'planned' },
  { id: 'ENT-2044', subtype: 'Water',        shader: 'planet-rocky',   status: 'planned' },
  { id: 'ENT-2045', subtype: 'Helium',       shader: 'planet-gas',     status: 'planned' },
  { id: 'ENT-2046', subtype: 'Circumbinary', shader: 'planet-gas',     status: 'planned' },
  { id: 'ENT-2047', subtype: 'Synestia',     shader: 'planet-extreme', status: 'planned' },
  { id: 'ENT-2050', subtype: 'Chthonian',    shader: 'planet-rocky',   status: 'planned' },

  // Moons (ENT-3xxx) — 15 subtypes, polished by V4
  { id: 'ENT-3010', subtype: 'Volcanic (Io)',    shader: 'moon-volcanic',    status: 'planned' },
  { id: 'ENT-3011', subtype: 'Cracked Ice',      shader: 'moon-icy',         status: 'planned' },
  { id: 'ENT-3012', subtype: 'Hazy Atmosphere',  shader: 'moon-atmospheric', status: 'planned' },
  { id: 'ENT-3013', subtype: 'Cratered Rocky',   shader: 'moon-rocky',       status: 'planned' },
  { id: 'ENT-3014', subtype: 'Irregular',        shader: 'moon-rocky',       status: 'planned' },
  { id: 'ENT-3015', subtype: 'Cryo-Geyser',      shader: 'moon-icy',         status: 'planned' },
  { id: 'ENT-3016', subtype: 'Ancient Surface',  shader: 'moon-rocky',       status: 'planned' },
  { id: 'ENT-3017', subtype: 'Magnetosphere',    shader: 'moon-icy',         status: 'planned' },
  { id: 'ENT-3018', subtype: 'Retrograde Capture', shader: 'moon-extreme',   status: 'planned' },
  { id: 'ENT-3019', subtype: 'Extreme Geology',  shader: 'moon-extreme',     status: 'planned' },
  { id: 'ENT-3020', subtype: 'Sponge',           shader: 'moon-extreme',     status: 'planned' },
  { id: 'ENT-3021', subtype: 'Shepherd',         shader: 'moon-minor',       status: 'planned' },
  { id: 'ENT-3022', subtype: 'Trojan',           shader: 'moon-minor',       status: 'planned' },
  { id: 'ENT-3023', subtype: 'Binary',           shader: 'moon-minor',       status: 'planned' },
  ...
  { id: 'ENT-4030', subtype: 'Pluto',  shader: 'smallbody-kbo',      status: 'planned', note: 'V1 T-V-06' },
  { id: 'ENT-4031', subtype: 'Ceres',  shader: 'smallbody-kbo',      status: 'planned', note: 'V1 T-V-06' },
  { id: 'ENT-4032', subtype: 'Eris',   shader: 'smallbody-kbo',      status: 'planned', note: 'V1 T-V-06' },
  { id: 'ENT-4040', subtype: 'Classical KBO',    shader: 'smallbody-kbo',     status: 'planned' },
  { id: 'ENT-4041', subtype: 'Plutino (Resonant KBO)', shader: 'smallbody-kbo', status: 'planned' },
  { id: 'ENT-4042', subtype: 'Scattered Disk',   shader: 'smallbody-kbo',     status: 'planned' },
  ...
  { id: 'ENT-5010', subtype: 'HII Giant',    shader: 'nebula-emission',        status: 'in-progress' },
  { id: 'ENT-5011', subtype: 'HII Compact',  shader: 'nebula-emission',        status: 'planned' },
  { id: 'ENT-5012', subtype: 'HI Region',    shader: 'nebula-emission',        status: 'planned' },
  { id: 'ENT-5020', subtype: 'PN Spherical', shader: 'nebula-planetary',       status: 'in-progress' },
  { id: 'ENT-5021', subtype: 'PN Bipolar',   shader: 'nebula-planetary',       status: 'planned' },
  { id: 'ENT-5022', subtype: 'PN Irregular', shader: 'nebula-planetary',       status: 'planned' },
  { id: 'ENT-5030', subtype: 'Reflection',   shader: 'nebula-reflection',      status: 'shipped' },
  { id: 'ENT-5040', subtype: 'Dark/MC',      shader: 'nebula-dark',            status: 'in-progress' },
  { id: 'ENT-5041', subtype: 'Bok Globule',  shader: 'nebula-dark',            status: 'planned' },
  { id: 'ENT-5050', subtype: 'SNR Shell',    shader: 'nebula-supernova',      status: 'in-progress', note: 'Doc17 alias nebula-snr renamed in T-V-26' },
  { id: 'ENT-5051', subtype: 'SNR Plerion',  shader: 'nebula-supernova',      status: 'planned' },
  { id: 'ENT-5060', subtype: 'Wolf-Rayet Nebula', shader: 'nebula-wolfrayet', status: 'planned', note: 'Doc17 alias nebula-wr renamed in T-V-26' },
  { id: 'ENT-5070', subtype: 'Protoplanetary', shader: 'nebula-protoplanetary', status: 'planned' },
  { id: 'ENT-5080', subtype: 'Superbubble',    shader: 'nebula-superbubble',    status: 'planned' },

  // Galaxies (ENT-6xxx) — 19 subtypes, polished by V6
  { id: 'ENT-6010', subtype: 'Spiral (SA)',  shader: 'galaxy-spiral',     status: 'in-progress' },
  { id: 'ENT-6011', subtype: 'Barred (SB)',  shader: 'galaxy-spiral',     status: 'planned' },
  { id: 'ENT-6012', subtype: 'Lenticular',   shader: 'galaxy-lenticular', status: 'shipped' },
  { id: 'ENT-6020', subtype: 'Giant Elliptical', shader: 'galaxy-elliptical', status: 'in-progress' },
  { id: 'ENT-6021', subtype: 'Dwarf Elliptical', shader: 'galaxy-elliptical', status: 'planned' },
  { id: 'ENT-6022', subtype: 'Dwarf Spheroidal', shader: 'galaxy-elliptical', status: 'planned' },
  { id: 'ENT-6030', subtype: 'Irregular I',  shader: 'galaxy-irregular', status: 'in-progress' },
  { id: 'ENT-6031', subtype: 'Irregular II', shader: 'galaxy-irregular', status: 'planned' },
  { id: 'ENT-6040', subtype: 'Seyfert',      shader: 'galaxy-agn',       status: 'planned' },
  { id: 'ENT-6041', subtype: 'Quasar',       shader: 'galaxy-agn',       status: 'planned' },
  { id: 'ENT-6042', subtype: 'Radio Galaxy', shader: 'galaxy-agn',       status: 'planned' },
  { id: 'ENT-6043', subtype: 'Blazar',       shader: 'galaxy-agn',       status: 'planned' },
  { id: 'ENT-6044', subtype: 'LINER',        shader: 'galaxy-agn',       status: 'planned' },
  { id: 'ENT-6050', subtype: 'Starburst',    shader: 'galaxy-starburst', status: 'planned' },
  { id: 'ENT-6051', subtype: 'Ring Galaxy',  shader: 'galaxy-morphology-special', status: 'planned' },
  { id: 'ENT-6052', subtype: 'Jellyfish',    shader: 'galaxy-morphology-special', status: 'planned' },
  { id: 'ENT-6053', subtype: 'ULIRG',        shader: 'galaxy-starburst', status: 'planned' },
  { id: 'ENT-6054', subtype: 'Ultra-Diffuse',shader: 'galaxy-morphology-special', status: 'planned' },
